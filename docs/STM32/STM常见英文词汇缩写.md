...
|ETM    |Embedded Trac Macrocell |嵌入式追踪宏单元|
...
|FPB    |Flash Patch And Breakpoint |闪存补丁及断点|
...
|12C    |Inter-Integrated Circuit |内置集成电路|
|ICE    |In-Circuit Emulator |在线仿真器|
|IDE    |Integrated Development Environment |集成开发环境|
|IIS    |Integrated Interface Of Sound |集成音频接口|
...
|JTAG-DP|JTAG Debug Port JTAG |调试端口|
|LR     |Link Register |链接寄存器|
|LSE    |Low Speed External |低速外部|
|LSI    |Low Speed Internal |低速内部|
|LSU    |Load Store Unit |存取单元|
|MIPS   |Million Instructions Per Second |每秒能执行的百万级指令的条数|
